...
echo "### Test commands"
docker exec -it ${PROJECT} git_pubkey ant-contrib
docker exec -it ${PROJECT} svn_authors ant-contrib
docker rm -f ${PROJECT} > /dev/null 2>&1 || true
echo
